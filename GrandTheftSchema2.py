...
parser.add_argument(
    "-S", "--setup", action="store_true", default=False, help="Setup the Environment"
)
parser.add_argument(
    "-v", "--verbose", action="store_true", default=False, help="Print additional Logmessages"
)

parser.add_argument(
    "-V", "--version", action="store_true", default=False, help="Show game- and Schemaversion"
)
parser.add_argument(
    "-O", "--osmstats", action="store_true", default=False, help="Show Information about OSM"
)
parser.add_argument(
    "-F", "--forcespawn", action="store_true", default=False, help="Force a Respawn"
)


parser.add_argument(
    "-n", "--username", default=getpass.getuser(), help="Set a Username. Defaults to executing user"
)
